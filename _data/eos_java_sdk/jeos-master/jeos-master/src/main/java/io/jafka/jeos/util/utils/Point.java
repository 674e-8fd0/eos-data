...
public class Point {
	...
	public Point twice() throws Exception {
		if (this.isInfinity()) {
			return this;
		}
	...
	public Point subtract(Point b) throws Exception {
		if (b.isInfinity()) {
			return this;
		}
		return add(b.negate());
	...
	public Point negate() throws Exception {
		return new Point(curve, this.x, this.y.negate(), this.compressed);
	}

	public Point multiply(BigInteger k) throws Exception {
		BigInteger e = k;
	...
	public Point multiplyTwo(BigInteger j, Point x, BigInteger k) throws Exception {
