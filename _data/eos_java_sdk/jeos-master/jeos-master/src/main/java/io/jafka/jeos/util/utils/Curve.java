...
public class Curve {
	...
	public Curve(BigInteger q, BigInteger a, BigInteger b) throws Exception {
		this.q = q;
	...
	public FieldElement fromBigInteger(BigInteger x) throws Exception {
		return new FieldElement(this.q, x);
	}

	public Point pointFromX(int isOdd, BigInteger x) throws Exception {
	...
	public Point decodePoint(byte[] encodedPoint) throws Exception {
		Point p = null;
