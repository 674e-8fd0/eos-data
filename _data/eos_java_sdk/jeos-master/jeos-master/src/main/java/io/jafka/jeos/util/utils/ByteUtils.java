...
//	 * @param b
	 ...
	 * @return
	 */
	public static byte[] writerAsset(String v) throws Exception {
	 ...
	 * @return
	 */
	public static byte[] writerSymbol(String v) throws Exception {
		String _value[] = v.split(" ");
		String amount = _value[0];
		if(amount==null || !amount.matches("^[0-9]+(.[0-9]+)?$")){
			throw new Exception("amount error");
...
//				.putLong(Long.parseLong(amount));
	 ...
	 * @return
	 */
	public static byte[] writeName(String v) throws Exception {
	...
	public static byte[] writerKey(String key) {
		io.jafka.jeos.util.utils.ByteBuffer bf = new io.jafka.jeos.util.utils.ByteBuffer();
